...
将数学模型形式相同的元件归为同一类，称为环节；将最常用最具代表性的环节总结出来，称为典型环节。

![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/c93b1fd6-9688-4461-b49f-c173152581d4/a928b75b-a888-42fe-a613-14c0ab721eec/image.png)

任意传递函数分解开化为尾一标准型，都是典型环节的乘积，即典型环节可看作构成传递函数的基本单元。不同的元部件可以有相同的传递函数，同一元部件选择不同的输入输出变量也可以有不同的传递函数。

另外，需要注意传递函数的负载效应问题，

$$e.g.$$ 图中，是否将$$u_a$$断开来分析$$u_c$$和$$u_r$$之间的传递函数，得到的结果是不同的。

![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/c93b1fd6-9688-4461-b49f-c173152581d4/044c1ee4-12f7-4828-892a-48e8043262ad/image.png)
...
![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/c93b1fd6-9688-4461-b49f-c173152581d4/99784060-7be8-44e3-b5ea-086e8754b42d/image.png)

![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/c93b1fd6-9688-4461-b49f-c173152581d4/ca274d4d-07ca-4253-b752-4968e99c8e87/image.png)

从结构图得到传递函数的一个方法是再结构图上进行等效化简，化简规则如下

![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/c93b1fd6-9688-4461-b49f-c173152581d4/1d290112-5f32-4993-8b7a-f727100c549d/image.png)
...
![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/c93b1fd6-9688-4461-b49f-c173152581d4/65a6b626-f730-45ff-a3b4-2de955af434c/image.png)

![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/c93b1fd6-9688-4461-b49f-c173152581d4/f9b8611d-968c-4ddf-b7cd-106e0d3052b9/image.png)
...
![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/c93b1fd6-9688-4461-b49f-c173152581d4/4f17218e-c3e0-4a16-90bb-f4e9abe05ecd/image.png)
...
![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/c93b1fd6-9688-4461-b49f-c173152581d4/f2d8ed8a-be92-40ae-968c-2203d155cf4c/image.png)

开环传递函数：$$\Phi(s) = \frac{1}{Ts}$$

闭环传递函数：$$\Phi(s) = \frac{1}{Ts + 1}$$

单位阶跃响应：$$c(t) = 1 - e^{-\frac{t}{T}}, t \ge 0$$

单位脉冲响应：$$c(t) = \frac{1}{T} e^{-\frac{t}{T}}, t \ge 0$$

单位斜坡响应：$$c(t) = (t - T) + Te^{-\frac{t}{T}}, t \ge 0$$

动态性能指标上，$$t_s = 3T$$

![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/c93b1fd6-9688-4461-b49f-c173152581d4/a03e03e6-b774-473b-b465-c05be470da1e/image.png)
...
![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/c93b1fd6-9688-4461-b49f-c173152581d4/5fa49d72-5090-41bf-b9a7-999393c6a5cf/image.png)
...
![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/c93b1fd6-9688-4461-b49f-c173152581d4/7d91daea-4c3f-4446-a243-65e0da82a97a/image.png)

![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/c93b1fd6-9688-4461-b49f-c173152581d4/fbb1450a-8679-426f-bc3e-55033b69daa7/image.png)

![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/c93b1fd6-9688-4461-b49f-c173152581d4/1afe9545-5b95-406f-8e88-56cbfc271f97/image.png)
...
![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/c93b1fd6-9688-4461-b49f-c173152581d4/df4fe5c7-a851-42f8-9f3b-45e311cf6d54/image.png)
