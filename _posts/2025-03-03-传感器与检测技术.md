...
$$
\begin{aligned}
&R_{1}\dot{I}_{1} + \text{j}\omega L_{1}\dot{I}_{1} - \text{j}\omega M\dot{I}_{2} = \dot{U} \\
&R_{2}\dot{I}_{2} + \text{j}\omega L_{2}\dot{I}_{2} - \text{j}\omega M\dot{I}_{1} = 0 \\
&Z = R_{1} + R_{2}\frac{\omega^2 M^2}{R_{2}^2 + \omega^2 L_{2}^2}+\text{j}\omega\left(L_{1} - L_{2}\frac{\omega^2 M^2}{R_{2}^2 + \omega^2 L_{2}^2}\right)
\end{aligned}
$$
