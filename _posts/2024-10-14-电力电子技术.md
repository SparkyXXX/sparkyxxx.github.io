...
![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/c93b1fd6-9688-4461-b49f-c173152581d4/70f2dd84-cea2-4edd-8f48-4759bea2c9e1/image.png)
...
![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/c93b1fd6-9688-4461-b49f-c173152581d4/4631a783-db53-4daf-88f6-c4f2c7aba0e2/image.png)

电压源和电流源共同激励下的谐振电路

![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/c93b1fd6-9688-4461-b49f-c173152581d4/f5286a2f-1ac9-4515-9718-54ff9773f324/image.png)

$$
\begin{aligned}
u_C=u_{C1} + u_{C2} = (u_{C0} - E)\cos \omega_r t - \sqrt{\frac{L}{C}}(I - I_0)\sin \omega_r t + E\\ i_{L2}\sqrt{\frac{L}{C}} = (E - u_{C0})\sin \omega_r t + (I_0 - I)\sqrt{\frac{L}{C}}\cos \omega_r t + I\sqrt{\frac{L}{C}}\\ (u_C - E)^2 + \left((i_L - I)\sqrt{\frac{L}{C}}\right)^2 = (u_{C0} - E)^2 + \left((I_0 - I)\sqrt{\frac{L}{C}}\right)^2
\end{aligned}
$$

![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/c93b1fd6-9688-4461-b49f-c173152581d4/a44cb9a1-8c4f-481f-92ac-5b1724dd27b6/image.png)

#### 7.3 准谐振变换电路

零电流开关准谐振变换电路

![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/c93b1fd6-9688-4461-b49f-c173152581d4/b5f52829-043d-45fb-98a4-da9402e00088/image.png)

谐振电感$$L_r$$和谐振电容$$C_r$$的设计取决于它的谐振频率$$\omega_r$$，和最大输出电流$$I_{Omax}$$。要实现功率开关的零电流关断，必须使$$i_L$$在关断之前降为零，即谐振轨迹圆与$$u_C$$轴有交点。

零电压开关准谐振变换电路

![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/c93b1fd6-9688-4461-b49f-c173152581d4/ecabb0d9-7f35-4dc0-9918-30f19e7f3298/image.png)

谐振电感$$L_r$$和谐振电容$$C_r$$的设计取决于它的谐振频率$$\omega_r$$和最小输出电流$$I_{Omin}$$。要实现功率开关的零电压开通，必须使$$u_C$$在开通之前降为零，即谐振轨迹圆与$$i_L\sqrt{\frac{L}{C}}$$轴有交点。
...
\begin{aligned}
i_L(0) &= i_L(T_s)\\
u_L(t) &= L\frac{\text{d}i_L}{\text{d}t}\\
\int_0^{T_S}u_L(t)\text{d}t &= L(i_L(T_s) - i_L(0)) = 0
\end{aligned}
$$
...
\begin{aligned}
u_C(0) &= u_C(T_s)\\
i_C(t) &= C\frac{\text{d}u_C}{\text{d}t}\\
\int_0^{T_S}i_C(t)\text{d}t &= C(u_C(T_s) - u_C(0)) = 0
\end{aligned}
$$
...
空载（电阻很大，电流很小，如开路）时，放电时间常数无穷大，输出电压最大$$U_d = \sqrt{6}U_2 = 2.45U_2$$
...
实现有源逆变的条件：(1)需要有一个提供逆变能量的直流电源，这个直流电源能从直流侧向交流侧输出能量。直流电源的极性与晶闸管的导通方向一致。(2)需要可控整流电路的控制角$$\alpha > 90°$$并控制$$\alpha$$使$$U_d < E$$。(3)在有源逆变工作状态时，要注意不能有触发脉冲丢失、缺相，且$$\beta$$不能小于最小值，并留有裕量，否则会使逆变失败，造成短路。
...
![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/c93b1fd6-9688-4461-b49f-c173152581d4/6e010895-7d20-4519-965a-264e6b435f4f/image.png)
...
![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/c93b1fd6-9688-4461-b49f-c173152581d4/730424dc-70ed-4bff-b815-d5fa5f738e0f/image.png)
